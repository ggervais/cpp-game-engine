...
${OBJECTDIR}/timing/GLFWTimer.o: timing/GLFWTimer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/timing/GLFWTimer.o timing/GLFWTimer.cpp
...
${OBJECTDIR}/input/GLFWInput.o: input/GLFWInput.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/input/GLFWInput.o input/GLFWInput.cpp
...
${OBJECTDIR}/timing/Timer.o: timing/Timer.cpp 
	${MKDIR} -p ${OBJECTDIR}/timing
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/timing/Timer.o timing/Timer.cpp

${OBJECTDIR}/input/Input.o: input/Input.cpp 
	${MKDIR} -p ${OBJECTDIR}/input
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/input/Input.o input/Input.cpp

${OBJECTDIR}/render/scenegraph/SceneNode.o: render/scenegraph/SceneNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/render/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/render/scenegraph/SceneNode.o render/scenegraph/SceneNode.cpp
...
${OBJECTDIR}/render/VertexBuffer.o: render/VertexBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/render
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/render/VertexBuffer.o render/VertexBuffer.cpp
